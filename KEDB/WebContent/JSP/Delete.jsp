...
if(form.choice[0].checked == true)
	{
	window.open("/KEDB/JSP/DeleteIncident.jsp?number="+number+"", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=600, height=600");
...
{
myWindow2 = window.open("/KEDB/JSP/DeleteProblem.jsp?number="+number+"", "_blank", "toolbar=yes, scrollbars=yes, resizable=yes, top=500, left=500, width=600, height=600");
