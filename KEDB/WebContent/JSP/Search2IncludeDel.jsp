...
<%} }%>
<table cellpadding="15"  align="center" border="0" style=" width: 45%;">
<tr>
...
<tr>
<td colspan="2"><span class="form_label">IncidentTitle: </span><input type="text" name="IT"/></td>

</tr>
<tr>
 <td colspan="2"><span class="form_label">IncidentDescription: </span><input type="text" name="ID"/></td>
</tr>
...
<td colspan="2"><span class="form_label">CauseCode: </span><input type="text" name="CC"/></td>
...
<input type="submit" value="Search" align="middle" width="23" class="form_styles" id="submit"/>
</td>
